...
class LargePROptimizer:
    ...
    def _calculate_priority(
        ...
        for priority in [FilePriority.SKIP, FilePriority.LOW, FilePriority.HIGH, FilePriority.CRITICAL]:
    ...
    def generate_review_summary(
        ...
        lines.append("*Note: Large PRs are automatically optimized to focus on the most important changes.*")
        
        return "\n".join(lines)


# Global optimizer instance
_optimizer: Optional[LargePROptimizer] = None
...
def init_optimizer(
    ...
    _optimizer = LargePROptimizer(
        max_tokens_per_review=max_tokens_per_review,
        max_files_to_review=max_files_to_review
    )
    return _optimizer


def get_optimizer() -> Optional[LargePROptimizer]:
