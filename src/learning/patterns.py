...
from learning.vector_store import VectorDocument, get_vector_store, VertexVectorStore
...
class PatternRetriever:
    ...
    def __init__(self, vector_store: Optional[VertexVectorStore] = None):
        """
    ...
    def _document_to_pattern(self, doc: VectorDocument) -> Optional[CodePattern]:
...
class PatternManager:
    ...
    async def get_patterns_for_review(
        ...
        """
        patterns = await self.retriever.find_relevant_patterns(
            code_chunk, language, top_k=3
        )
...
def get_pattern_manager() -> Optional[PatternManager]:
