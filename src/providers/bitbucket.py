...
from models.events import PREvent, PRAction, ReviewComment
...
class BitbucketAdapter(ProviderAdapter):
    ...
    def __init__(self, webhook_secret: str, username: Optional[str] = None, app_password: Optional[str] = None):
    ...
    def parse_webhook(self, payload: Dict[str, Any], headers: Dict[str, str]) -> Optional[PREvent]:
        ...
        source_repo = pr_data.get("source", {}).get("repository", {})
