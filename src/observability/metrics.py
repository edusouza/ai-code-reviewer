...
class CloudMetricsClient:
    ...
    def record_timing(
        ...
        self.record_histogram(
            metric_name=f"{metric_name}_duration_seconds",
...
_metrics_client: Optional[CloudMetricsClient] = None
...
def init_metrics(
    ...
    _metrics_client = CloudMetricsClient(
...
def get_metrics_client() -> Optional[CloudMetricsClient]:
