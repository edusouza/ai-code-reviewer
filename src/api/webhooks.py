...
async def github_webhook(
    ...
    try:
        ...
        logger.info(
            f"Received GitHub PR event: {event.repo_owner}/{event.repo_name}#{event.pr_number}"
        )
...
async def gitlab_webhook(
    ...
    try:
        ...
        logger.info(
            f"Received GitLab MR event: {event.repo_owner}/{event.repo_name}!{event.pr_number}"
        )
...
async def bitbucket_webhook(
    ...
    try:
        ...
        logger.info(
            f"Received Bitbucket PR event: {event.repo_owner}/{event.repo_name}#{event.pr_number}"
        )
